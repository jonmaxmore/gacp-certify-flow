# 🌿 ระบบขอใบอนุญาตปลูกสมุนไพรไทย และ Audit เพื่อออกใบอนุญาต (GACP Certification Platform)

## 🏛️ Thai Herbal License Application & Audit Platform

**กรมการแพทย์แผนไทยและการแพทย์ทางเลือก (DTAM)**  
*กระทรวงสาธารณสุข ราชอาณาจักรไทย*

**เว็บไซต์สำหรับขอใบอนุญาตปลูกสมุนไพรไทย 6 ชนิดหลัก และระบบ Audit เพื่อออกใบอนุญาต**

### 🌿 สมุนไพรไทย 6 ชนิดหลักที่รองรับ:
1. **กัญชา (Cannabis)** - สมุนไพรควบคุมพิเศษ
2. **ขมิ้นชัน (Turmeric)** - สมุนไพรอาหาร  
3. **ขิง (Ginger)** - สมุนไพรอาหาร
4. **กระชายดำ (Black Galingale)** - สมุนไพรเวชภัณฑ์
5. **ไพล (Plai)** - สมุนไพรเวชภัณฑ์
6. **กระท่อม (Kratom)** - สมุนไพรควบคุม

### 🛡️ ความปลอดภัยข้อมูล PDPA
ระบบปกป้องข้อมูลส่วนบุคคลตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 (PDPA)
