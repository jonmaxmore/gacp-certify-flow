    ...
    Tables: {
      applicant_info: {
        Row: {
          ...
          entity_representative_name: string | null
          entity_representative_position: string | null
          id: string
          individual_address: string | null
          individual_email: string | null
          individual_id_number: string | null
      ...
      cultivation_areas: {
        ...
        Relationships: [
          {
            foreignKeyName: "cultivation_areas_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "applications"
            referencedColumns: ["id"]
      ...
      self_certification: {
        ...
        Relationships: [
          {
            foreignKeyName: "self_certification_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "applications"
            referencedColumns: ["id"]
