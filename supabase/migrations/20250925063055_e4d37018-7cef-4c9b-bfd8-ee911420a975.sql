-- Update certificate generation to use correct application data mapping
-- Add more crop types support
...
-- Insert configuration for supported crop types including mango, longan, lychee, and cannabis
