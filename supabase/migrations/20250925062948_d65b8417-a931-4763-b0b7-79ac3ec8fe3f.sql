-- Add more crop types to support mango, longan, lychee in addition to cannabis
-- Update the auto_issue_certificate function to use correct application data

-- First, let's update the auto_issue_certificate function to properly map application data to certificate
...
-- Insert some common crop types for Thailand GACP certification
-- This will help with data consistency and provide options for users
